...
export const metadata: Metadata = {
  title: "Luxe Network",
  description: "Join the Luxe Network. The strongest brands today are community and product combined. Secure your spot in the inner circle.",
};
  ...
  return (
    <main className="flex min-h-screen flex-col w-full bg-background pt-24">
      <div className="container mx-auto px-8 sm:px-10 lg:px-16 py-12 md:py-20 text-center max-w-5xl">
        <h1 className="text-4xl md:text-7xl font-black mb-6 tracking-tight uppercase italic underline decoration-primary decoration-4 underline-offset-8">Luxe Network</h1>
        <p className="text-lg md:text-2xl text-muted-foreground leading-relaxed font-bold tracking-tight">
          Luxe Network is more than just fashion. It is a growing community for women who are intentional about how they show up, how they live, and how they express themselves.
        </p>
        <p className="text-lg md:text-xl text-muted-foreground leading-relaxed mt-4 font-medium">
          Through Luxe Network, we are building a space where women can connect, share, and grow together while embracing confidence, style, and a refined soft life mindset.
        </p>
      </div>
      ...
      <section className="py-24 bg-secondary/30">
        <div className="container mx-auto px-6 text-center max-w-3xl">
          <h2 className="text-xs font-bold tracking-[0.4em] uppercase text-primary mb-4">Join The Experience</h2>
          <h3 className="text-3xl md:text-4xl font-black tracking-tight mb-8 uppercase">The Luxe Experience</h3>
